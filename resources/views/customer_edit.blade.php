...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="">
        ...
        <div class="container">
            ...
            <br>
            <div>
                <form method="post" action="{{ url('customer/edit') }}/{{$customer_detail->Customer_Id}}">
                 @csrf
                  <div class="form-group">
                    <label>Birthday</label>
                    <input type="date" class="form-control" name="birthday" value="{{$customer_detail->Birthday}}" required>
                  </div>

                  <div class="form-group">
                    <label>Percent 1</label>
                    <input type="text" class="form-control" name="percent_1" value="{{$customer_detail->Percent_1}}" required>
                  </div>

                  <div class="form-group">
                    <label>Percent 2</label>
                    <input type="text" class="form-control" name="percent_2" value="{{$customer_detail->Percent_2}}" required>
                  </div>
